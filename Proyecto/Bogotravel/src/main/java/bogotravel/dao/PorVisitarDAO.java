...
public class PorVisitarDAO {
  ...
  public boolean agregar(PorVisitar porVisitar) {
    String sql =
        "INSERT INTO por_visitar (id_lugar, email_usuario, prioridad, recordatorio) VALUES (?, ?, ?, ?)";
    ...
    try (Connection connection = DBConnection.getConnection();
      ...
      statement.setDate(
          4,
          porVisitar.getRecordatorio() != null ? Date.valueOf(porVisitar.getRecordatorio()) : null);
        ...
        PorVisitar pv =
            new PorVisitar(
                ...
                resultSet.getDate("recordatorio") != null
                    ? resultSet.getDate("recordatorio").toLocalDate()
                    : null);
        lista.add(pv);
      }
