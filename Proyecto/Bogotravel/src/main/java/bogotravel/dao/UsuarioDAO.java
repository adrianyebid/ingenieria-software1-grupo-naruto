...
public class UsuarioDAO {
  /**
   * Registra un nuevo usuario en la base de datos. La contraseña se almacena en formato hasheado
   * con BCrypt.
   *
  ...
  /**
   * Valida las credenciales ingresadas por el usuario. Compara el password plano con el almacenado
   * en la base de datos.
   *
