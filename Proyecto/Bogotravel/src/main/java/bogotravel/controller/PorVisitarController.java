...
public class PorVisitarController {
  ...
  @FXML private Label nombreLugarLabel;

  @FXML private TextField prioridadField;

  @FXML private DatePicker recordatorioPicker;
  ...
  /**
   * Acción que guarda el lugar seleccionado en la lista de lugares por visitar, con su prioridad y
                ...
                javafx.application.Platform.runLater(
                    () -> {
                      try {
                        ...
                        Parent root =
                            FXMLLoader.load(
                                getClass().getResource("/bogotravel/view/InicioView.fxml"));
